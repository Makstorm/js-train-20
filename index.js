...
Car.prototype.drive = function (num) {
  console.log(`Подорожуємо ${num} кілометрів у ${this.brand} ${this.model}`);
};

// Використовуємо bind для зв'язування методу drive з конкретним об'єктом car.

const bindedFunc = Car.prototype.drive.bind(car);
...
const elCar = new ElectricCar("Tesla", "Model S", 2020, 10000, 100);
